...
import { addProductToCart, removeSigleItemFromCart } from "@/actions/shopping-cart";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  function onRemoveItem() {
    removeSigleItemFromCart(product.id);
    router.refresh();
  }

  return (
    <div className="flex items-center shadow rounded-lg w-full bg-zinc-500 border-gray-100">
      {/* Product Image */}
      <div className="p-2">
        <Image
          width={200}
