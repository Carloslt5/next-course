    ...
    <div className="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
      <div className="px-6 flex items-center justify-between space-x-4">
        ...
        <div className="flex space-x-2">
          ...
          <button className="flex p-2 items-center justify-center gap-2 h-10 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200">
            <span className="text-sm  text-blue-800 font-bold">{getTotalCount()}</span>
